        ...
        <section id="inner-wrapper" class="login">
                ...
                <form action="/ProjetEncheresGroupe2/Inscription" method="POST">
                    ...
                    <div class="col-md-6 form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><i>Pseudo</i></span>
                    ...
                    <div class="col-md-6 form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><i>Nom</i></span>
                    ...
                    <div class="col-md-6 form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><i>Prénom</i></span>
                            <input type="text" class="form-control" value="${prenom}" name="prenom">
                    ...
                    <div class="col-md-6 form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><i>Téléphone</i></span>
                    ...
                    <div class="col-md-6 form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><i>Rue</i></span>
                            <input type="text" class="form-control" value="${rue}" name="rue">
                    ...
                    <div class="col-md-6 form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><i>Code postal</i></span>
                    ...
                    <div class="col-sm-6 form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><i>Mot de passe</i></span>
                    ...
                    <div class="col-sm-6 form-group">
                        <div class="input-group">
                            <span class="input-group-addon"><i>Confirmation</i></span>
           ...
           <!---------BOUTON CREER ------>
                    ...
                    <div class="col-md-2 col-md-offset-4" >
                        <button type="button" class="btn btn-success btn-block-annuler" onclick="window.location.href='../../index.html';" style="float: right">Annuler</button>
                    </div>
                    <!---------Marge bottom------>
